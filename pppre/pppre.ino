...
//******************电机启动初始值  作者：Sunny**********************//
int motorDeadZone = 10;//高频时电机启动初始值高约为130，低频时电机启动初始值低约为30,和电池电压、电机特性、PWM频率等有关，需要单独测试
...
void allServo(){
  setAngel(servo1,180,50);
  setAngel(servo2,0,120);
  setAngel(servo3,170,45);
  setAngel(servo4,0,120);
}
/**************************************************************************
...
void Set_PWM(int motorRight,int motorLeft){
  ...
  else if (motorLeft < 0)   analogWrite(AIN1, -motorLeft-motorDeadZone-5), analogWrite(AIN2, 0);//高频时电机启动初始值高约为130，低频时电机启动初始值低约为30
  ...
  else if (motorRight < 0)   analogWrite(DIN2, -motorRight-motorDeadZone-4-5), analogWrite(DIN1, 0);//高频时电机启动初始值高约为130，低频时电机启动初始值低约为30
...
{   
    ...
    if(i)
    {
      switch(vel)
      {
//        case 15:Straight(1,expect);break;//1111
//        case 0:Straight(1,expect);break;//0000
//        case 8:Set_PWM(90,130 );break;//1000
//        case 4:Set_PWM(100,120 );break;//0100
//        case 2:Set_PWM(120,100 );break;//0010
//        case 1:Set_PWM(130,90 );break;//0001
//        case 6:Straight(1,expect);//Set_PWM(110,110);break;//0110
//        case 12:Set_PWM(100,120 );break;//1100
//        case 3:Set_PWM(120,100 );break;//0011

        // case 15:Straight(1,expect);break;//1111
        // case 0:Straight(1,expect);break;//0000
        // case 8:Set_PWM(90,130 );delay(100);Set_PWM(170,90 );delay(100);break;//1000
        // case 4:Straight(1,expect);//Set_PWM(100,120 );break;//0100
        // case 2:Straight(1,expect);//Set_PWM(120,100 );break;//0010
        // case 1:Set_PWM(130,90 );delay(100);Set_PWM(90,170 );delay(100);break;//0001
        // case 6:Straight(1,expect);//Set_PWM(110,110);break;//0110
        // case 12:Straight(1,expect);//Set_PWM(100,120 );break;//1100
        // case 3:Straight(1,expect);//Set_PWM(120,100 );break;//0011
...
//        float diff = yaw-last-expect;
        ...
        //   Set_PWM(110,110);
        // }
        // else if(diff>0.5) //0.5右转
        // {
        //   Set_PWM(120+bias,80-bias);
        // }
        // else   左转
        // {
        //   Set_PWM(80-bias,120+bias);
        // }
        case 15:StraightAdjust(1,expect,0);break;//1111
        case 0:StraightAdjust(1,expect,0);break;//0000
        case 8:StraightAdjust(1,expect,-15);delay(50);break;
        // Set_PWM(90,130 );delay(100);Set_PWM(170,90 );delay(100);break;//1000
        case 4:StraightAdjust(1,expect,-5);delay(50);break;//Set_PWM(100,120 );break;//0100
        case 2:StraightAdjust(1,expect,5);delay(50);break;//Set_PWM(120,100 );break;//0010
        case 1:StraightAdjust(1,expect,15);delay(50);break;
        ...
        case 12:StraightAdjust(1,expect,15);delay(50);break;//Set_PWM(100,120 );break;//1100
        case 3:StraightAdjust(1,expect,15);delay(50);break;//Set_PWM(120,100 );break;//0011
    ...
    else
    {
      ...
      // switch(vel)
      // {
      //   case 15:Straight(0,expect);break;//1111
      //   case 0:Straight(0,expect);break;//0000
      //   case 8:Set_PWM(-100,-140 );break;//1000
      //   case 4:Set_PWM(-110,-130 );break;//0100
      //   case 2:Set_PWM(-130,-110 );break;//0010
      //   case 1:Set_PWM(-140,-100 );break;//0001
      //   case 6:Set_PWM(-120,-120);break;//0110
      //   case 12:Set_PWM(-110,-130 );break;//1100
      //   case 3:Set_PWM(-130,-110 );break;//0011
      // }
    }
}
// 同时使用巡线和加速度计
...
{   
  if(i)
  {
    ...
    //   // Set_PWM(120,120);
    //   // delay(5);
    //   Set_PWM(115+di+bias,115);
    // }
    // else
    // {
    //   // Set_PWM(120,120);
    //   // delay(5);
    //   Set_PWM(115,115-di+bias);
    // }
    if(abs(diff)<1) //0.5
    {
      // 好像两边速度一样右边的轮子会比较快
